...
<div class="container">
 ...
 </article> <article class="sliders-block">
...
<div class="button-block button-block_slider">
 <button class="btn-active" id="forBlock-1">blog</button> <button id="forBlock-2">video</button> <button id="forBlock-3">podcast</button>
</div>
 </article> <article class="team">
<div class="container">
...
<div class="slider-bisiness-cases">
 ...
 </article> <button class="ask-professionals btn"> ask professionals </button> </section><?require($_SERVER["DOCUMENT_ROOT"]."/bitrix/footer.php");?>